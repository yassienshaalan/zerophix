...
print("\nValidation Results:")
print(f"✓ Valid TFN (123-456-782) detected: {tfn_valid == 1}")
print(f"✓ Invalid TFN (123-456-789) rejected: {tfn_invalid == 0}")
print(f"✓ Valid ABN (51 824 753 556) detected: {abn_valid == 1}")
print(f"✓ Invalid ABN (51 824 753 557) rejected: {abn_invalid == 0}")
print(f"✓ Valid ACN (000-000-019) detected: {acn_valid == 1}")
print(f"✓ Invalid ACN (000-000-018) rejected: {acn_invalid == 0}")
